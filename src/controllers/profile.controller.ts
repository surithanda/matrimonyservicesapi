...
export const createProfileAddress = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const deleteProfileAddress = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
//
export const getProfileEmployment = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const createProfileEmployment = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
//
export const getProfileProperty = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const createProfileProperty = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
//
export const getFamilyReference = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
//
export const getProfileLifestyle = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const createProfileLifestyle = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
const fileFilter = (
  ...
  try {
    ...
    if (isNaN(photoType) || !validPhotoTypes.includes(photoType)) {
      return cb(
        new Error(
          "Invalid photo type. Must be 450 (profile), 454 (cover), or 456 (additional)"
        )
      );
    }
  ...
  try {
    ...
    if (!result.success) {
      ...
      try {
        ...
        console.error("Failed to clean up local file after database error:", error);
      }
...
export const getProfileHobbies = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const addProfileHobby = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const removeProfileHobby = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const addProfileFamily = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const updateProfileFamily = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
    ...
    if (!profile_id || !family) {
      return res
        .status(400)
        .json({ message: "profile_id and family are required" });
    }
    const result = await profileService.updateProfileFamily(profile_id, family);
    return res
      .status(200)
      .json({ message: "Family record updated successfully", data: result });
  } catch (error: unknown) {
    return res.status(500).json({
      message: error instanceof Error ? error.message : "Unknown error",
    });
...
export const deleteProfileFamily = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
    ...
    if (!profile_id || !family_id) {
      return res
        .status(400)
        .json({ message: "profile_id and family_id are required" });
    }
    const result = await profileService.deleteProfileFamily(
      profile_id,
      family_id
    );
    return res
      .status(200)
      .json({ message: "Family record deleted successfully", data: result });
  } catch (error: unknown) {
    return res.status(500).json({
      message: error instanceof Error ? error.message : "Unknown error",
    });
...
export const getUserPreferences = async (
  ...
  try {
    ...
    const preferenceId = req.query.preference_id
      ? parseInt(req.query.preference_id as string)
      : undefined;
    ...
    const result = await profileService.getUserPreferences(
      profileId,
      preferenceId,
      req.user?.email
    );
...
export const createFavoriteProfile = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const updateProfileProperty = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const deleteProfileProperty = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const updateFamilyReference = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const deleteFamilyReference = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const updateProfileEmployment = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const deleteProfileEmployment = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const updateProfileLifestyle = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
...
export const deleteProfileLifestyle = async (
  req: AuthenticatedRequest,
  res: Response
) => {
  try {
